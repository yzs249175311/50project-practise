class VirtualScroller {
    ...
    loadVisibleItem() {
        for (let index = this.firstVisibleItemIndex; index < this.firstVisibleItemIndex + this.totalItemCount; index++) {
            if (this.data[index]) {
    ...
    updatePadding() {
        this.contentBox.style.paddingTop = this.firstVisibleItemIndex * this.rowHeight + "px"
        this.contentBox.style.paddingBottom = (this.data.length - (this.firstVisibleItemIndex + this.totalItemCount)) * this.rowHeight + "px"
    }
    ...
    contentBoxUp() {
        for (let index = this.firstVisibleItemIndex; index > this.hiddenItemCount; index--) {
            ...
            if (data) {
                if (this.bufferCount > 0) {
                    while (this.bufferCount) {
                        let bufferData = this.data[this.firstVisibleItemIndex + this.totalItemCount - this.bufferCount]
